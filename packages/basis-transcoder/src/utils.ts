...
export function isFormatSupported(format: TranscoderTextureFormat): boolean {
  ...
  switch (format) {
    ...
    case TranscoderTextureFormat.cTFBC7_RGBA:
      return !!gl1.getExtension('WEBGL_compressed_texture_s3tc');

    case TranscoderTextureFormat.cTFASTC_4x4_RGBA:
      return !!gl1.getExtension('WEBGL_compressed_texture_astc');
    ...
    case TranscoderTextureFormat.cTFPVRTC2_4_RGBA:
      return !!gl1.getExtension('WEBGL_compressed_texture_pvrtc');

    case TranscoderTextureFormat.cTFETC2_EAC_R11:
    case TranscoderTextureFormat.cTFETC2_EAC_RG11:
      return !!gl1.getExtension('WEBGL_compressed_texture_etc');
...
const formatNames: Partial<Record<TranscoderTextureFormat, string>> = {
  // ETC1-2 formats
  [TranscoderTextureFormat.cTFETC1_RGB]: 'ETC1 RGB',
  [TranscoderTextureFormat.cTFETC2_RGBA]: 'ETC2 RGBA',

  // BC1-7 formats (Desktop)
  ...
  // ASTC formats (Mobile - ARM Mali, Desktop)
  [TranscoderTextureFormat.cTFASTC_4x4_RGBA]: 'ASTC 4x4 RGBA',
  [TranscoderTextureFormat.cTFASTC_HDR_4x4_RGBA]: 'ASTC HDR 4x4 RGBA',
  [TranscoderTextureFormat.cTFASTC_HDR_6x6_RGBA]: 'ASTC HDR 6x6 RGBA',

  // ATC formats (Mobile - Adreno)
  ...
  // HDR formats
  [TranscoderTextureFormat.cTFBC6H]: 'BC6H HDR RGB',
  ...
  // Uncompressed HDR formats
  [TranscoderTextureFormat.cTFRGB_HALF]: 'RGB Half Float',
  [TranscoderTextureFormat.cTFRGBA_HALF]: 'RGBA Half Float',
  [TranscoderTextureFormat.cTFRGB_9E5]: 'RGB 9E5 Shared Exponent',
};